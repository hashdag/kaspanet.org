<template>
    <div class="home">
        ...
        <h5>What is Kaspa?</h5>
        <p>
            <a href="https://hashdag.medium.com/in-which-i-run-with-the-ghosts-of-my-hometown-95ad503c88c" target="_blank">The story of Kaspa</a>
        </p>
        ...
        <p>
            Kaspa is a community project, completely open source, no central governance, no biz model. The mainnet was openly launched without premining or any other preallocation of coins.
        </p>
